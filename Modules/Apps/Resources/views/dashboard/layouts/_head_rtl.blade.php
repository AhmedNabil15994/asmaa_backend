<head>
  ...
  <link href="{{ url('admin/assets/global/plugins/grapick/grapick.min.css') }}"
        rel="stylesheet"
        type="text/css" />
  ...
  <link href="/admin/assets/global/plugins/jquery-minicolors/jquery.minicolors.css"
    rel="stylesheet"
    type="text/css">

    <link href="/admin/assets/global/plugins/bootstrap-colorpicker/css/colorpicker.css"
      rel="stylesheet"
      type="text/css" />
	<link href="/admin/assets/layouts/layout/css/custom-rtl.min.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="/admin/js/plugins/bootstrap-fileinput/css/fileinput.min.css">
